...
exports.getTicTacToeStatus = void 0;
const getTicTacToeStatus = (board) => {
    ...
    if ((diagonal1Val === 1 || diagonal1Val === 2) &&
        board[4] === diagonal1Val &&
        board[8] === diagonal1Val) {
        return diagonal1Val;
    }
    const diagonal2Val = board[2];
    if ((diagonal2Val === 1 || diagonal2Val === 2) &&
        board[4] === diagonal2Val &&
        board[6] === diagonal2Val) {
        return diagonal2Val;
    }
